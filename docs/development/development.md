...
1. **Update Requirements**: Add requirements to the appropriate file in `requirements/` (see [Requirements Documentation](../requirements/))
2. **Plan Database Changes**: Update Drizzle schema if needed
